...
use vector_extensions::sources::conprof::topology::fetch::{TopologyFetcher, FetchError};
...
mod topology_tests {
    ...
    fn test_component_conprof_address() {
        ...
        assert_eq!(pd_component.conprof_address(), Some("127.0.0.1:2379".to_string()));
        ...
        assert_eq!(tidb_component.conprof_address(), Some("127.0.0.1:10080".to_string()));
        ...
        assert_eq!(tikv_component.conprof_address(), Some("127.0.0.1:20180".to_string()));
        ...
        assert_eq!(tiflash_component.conprof_address(), Some("127.0.0.1:8123".to_string()));
        ...
        assert_eq!(tiproxy_component.conprof_address(), Some("127.0.0.1:6001".to_string()));
        ...
        assert_eq!(lightning_component.conprof_address(), Some("127.0.0.1:8286".to_string()));
    }
